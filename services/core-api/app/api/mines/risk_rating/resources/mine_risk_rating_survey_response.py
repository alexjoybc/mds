...
class MineRiskRatingSurveyResponseListResource(Resource, UserMixin):
    ...
    def post(self):
        ...
        # Enforce correct creation timestamp
        mine_risk_rating_survey_response.create_timestamp = datetime.now()

        # TODO: Enforce correct calculation of the rating
        #mine_risk_rating_survey_response.rating = MineRiskRatingSurveyDefinition.CalculateRating(mine_risk_rating_survey_response)
